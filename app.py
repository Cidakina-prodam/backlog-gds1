...
with st.sidebar:
    ...
    uploaded = st.file_uploader(
        "CSV ou XLSX do SIGA (ExportacaoDemanda)",
        type=["csv", "xlsx"], accept_multiple_files=True,
    )
    snapshot_date = st.date_input("Data desta coleta", value=datetime.date.today())
...
if st.session_state.dataset is None:
    st.info("⬅️ Suba os arquivos do SIGA na barra lateral e clique em **Processar upload** para gerar o dashboard.")
else:
