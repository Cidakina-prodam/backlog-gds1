...
<div class="wrap">
  ...
  <section class="block">
    <div class="block-head">
      <div>
        <div class="block-num">01 · PIPELINE</div>
  ...
  <section class="block">
    <div class="block-head">
      <div>
        <div class="block-num">02 · RESPONSABILIZAÇÃO</div>
  ...
  <section class="block">
    <div class="block-head">
      <div>
        <div class="block-num">03 · TEMPO EM ABERTO</div>
        <div class="block-title">Aging do backlog</div>
      </div>
      <div class="block-note">Dias corridos desde a criação da demanda até hoje (23/07/2026).</div>
    </div>
    <div class="panel">
  ...
  <section class="block">
    <div class="block-head">
      <div>
        <div class="block-num">04 · ESFORÇO</div>
  ...
  <section class="block">
    <div class="block-head">
      <div>
        <div class="block-num">05 · DETALHAMENTO</div>
...
function renderEvolution(){
  ...
  const W=1000,H=300,padL=50,padR=20,padT=20,padB=36;
  ...
  visible.forEach(k=>{
    ...
    rows.forEach((r,i)=>{
      ...
      if(i===rows.length-1){
        html += `<text x="${x(i)+8}" y="${y(r.backlog_total)+4}" font-family="IBM Plex Mono" font-size="11" font-weight="600" fill="${col}">${r.backlog_total}</text>`;
      }
    });
  });
...
def build_dashboard_html(dataset: dict, history_rows: list) -> str:
    data = dict(dataset)
