...
#listagem table{width:100%;border-collapse:collapse;font-size:13px;table-layout:fixed;min-width:940px}
...
#listagem th:nth-child(7),#listagem td:nth-child(7){width:9%}
#listagem th:nth-child(8),#listagem td:nth-child(8){width:9%}
#listagem th:nth-child(9),#listagem td:nth-child(9){width:5%;white-space:nowrap}
#listagem th:nth-child(10),#listagem td:nth-child(10){width:9%}
#listagem th:nth-child(11),#listagem td:nth-child(11){width:5%}
#listagem th:nth-child(12),#listagem td:nth-child(12){width:5%}
...
#listagem td:nth-child(11),#listagem td:nth-child(12),#listagem th:nth-child(11),#listagem th:nth-child(12),#listagem td:nth-child(9),#listagem th:nth-child(9){text-align:right}
