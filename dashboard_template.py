...
#listagem table{width:100%;border-collapse:collapse;font-size:13px;table-layout:fixed;min-width:980px}
...
#listagem th:nth-child(2),#listagem td:nth-child(2){width:6%}
#listagem th:nth-child(3),#listagem td:nth-child(3){width:18%}
#listagem th:nth-child(4),#listagem td:nth-child(4){width:6%}
#listagem th:nth-child(5),#listagem td:nth-child(5){width:7%}
#listagem th:nth-child(6),#listagem td:nth-child(6){width:10%}
#listagem th:nth-child(7),#listagem td:nth-child(7){width:7%}
#listagem th:nth-child(8),#listagem td:nth-child(8){width:7%}
...
#listagem th:nth-child(11),#listagem td:nth-child(11){width:6%}
#listagem th:nth-child(12),#listagem td:nth-child(12){width:6%}
#listagem th:nth-child(13),#listagem td:nth-child(13){width:6%}
#listagem .status-pill{white-space:nowrap;max-width:100%;overflow:hidden;text-overflow:ellipsis;vertical-align:middle}
#listagem .badge{max-width:100%;overflow:hidden;text-overflow:ellipsis;padding:3px 7px}
#listagem td:nth-child(n+11),#listagem th:nth-child(n+11),#listagem td:nth-child(9),#listagem th:nth-child(9){text-align:right}
